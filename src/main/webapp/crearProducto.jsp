...
<h2>Creación Nuevo Producto</h2>
      <form action="crearProducto" method="post">
            <label for="nombre" class="form-label">Nombre</label>
            <input type="text" class="form-control" id="nombre_producto" name="nombre_producto" placeholder="Ingrese nombre producto"> <br>
            <label for="precio" class="form-label">Precio</label>
            <input type="text" class="form-control" id="precio_producto" name="precio_producto" placeholder="Ingrese precio del producto"><br>
            <label for="descripcion" class="form-label">Descripción </label>
            <input type="text" class="form-control" id="descripcion_producto" name="descripcion_producto" placeholder="Ingrese descripción de producto"><br>
           ...
           <!--botones-->
            <button type="submit" class="btn btn-dark mb-4 p-2">Registrar</button>

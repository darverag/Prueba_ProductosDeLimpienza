...
public class BaseDatos {
	...
	private String sServidor = "localhost"; //es igual a 127.0.0.1 //Datos para conectarse al servidor (Se puede colocar la ip
	private String sUsuario = "root";
	private String sPassword = "123456"; //clave de base de datos

...
public class ProductoDAOImpl implements ProductoDAO{
	...
	public int crearProducto(Producto producto) {
		...
		String query = "INSERT INTO producto(nombre_producto, precio_producto, descripcion_producto, id_categoria) values('"+ producto.getNombre_producto()+
				"','"+ producto.getPrecio_producto()+"','"+ producto.getDescripcion_producto()+"','"+producto.getCategoria().getId_categoria()+"')";
	...
	public int modificarProducto(Producto producto) { //EDITAR
		...
		+ producto.getDescripcion_producto()+"', id_categoria='"+producto.getCategoria().getId_categoria() 
	...
	public ArrayList<Producto> obtenerListarProductos() {
		...
		try {
			...
			while(resultado.next()) {
				...
				//llenar el objeto nuevo por cada registro
				Producto producto= new Producto (productoId,nombre_producto, precio_producto, descripcion_producto, categoria);

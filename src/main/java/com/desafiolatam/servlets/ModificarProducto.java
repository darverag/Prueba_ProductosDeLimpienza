...
public class ModificarProducto extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Producto producto = new Producto(Integer.parseInt(id_producto), nombre_producto,Integer.parseInt(precio_producto), descripcion_producto, categoria);
		...
		if(resultado == 1) {
			request.setAttribute("msgExito", "Se modificó correctamente la información del producto, para más modificaciones ir a la opción Listar");			
		}else {
